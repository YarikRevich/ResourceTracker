...
@Service
public class DestroyClientCommandService implements IClientCommand<TerraformDeploymentApplicationResult> {
  @Autowired private ConfigService configService;

  public TerraformDeploymentApplicationResult process() {
