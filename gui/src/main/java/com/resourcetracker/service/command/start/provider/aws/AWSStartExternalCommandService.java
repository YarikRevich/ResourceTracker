package com.resourcetracker.service.command.start.provider.aws;
  ...
  public void process() throws ApiServerException {
    ...
    if (validationSecretsApplicationResult.getValid()) {
      ...
      if (validationScriptApplicationResult.getValid()) {
        ...
        System.out.printf(
            "Deployment with the given configuration was started, please execute the following"
                + " command:\n'%s'",
            configService.getKafkaHostModificationCommand(
