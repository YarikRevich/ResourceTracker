package com.resourcetracker.service.element.progressbar.stage.settings;
...
@Service
public class SettingsCircleProgressBar implements IElementResizable, IElement<VBox> {
  UUID id = UUID.randomUUID();

  public SettingsCircleProgressBar(@Autowired PropertiesEntity properties) {
