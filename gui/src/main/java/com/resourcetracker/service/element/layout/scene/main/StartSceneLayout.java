...
public class StartSceneLayout implements IElementResizable, IElement<GridPane> {
    ...
    public StartSceneLayout(
        ...
        ConnectionStatusBox connectionStatusHBox = new ConnectionStatusBox(
                connectionStatusImageView.getContent());

        ContentGrid<LandingAnnouncementText> contentGrid = new ContentGrid<>(menuButtonVBox, landingAnnouncementText);
        ...
        grid.addColumn(
                0,
                connectionStatusHBox.getContent(),
                contentGrid.getContent(),
                footerGrid.getContent());
