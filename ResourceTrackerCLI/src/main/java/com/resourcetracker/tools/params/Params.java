...
public class Params {
    ...
    public static void ifStartDo(ParamCallback callback) {
        if (start.getValue()){
            callback.call();
            System.exit(0); 
        }
    ...
    public static void ifStopDo(ParamCallback callback) {
        if (stop.getValue()){
            callback.call();
            System.exit(0); 
        }
    ...
    public static void ifValidateDo(ParamCallback callback) {
