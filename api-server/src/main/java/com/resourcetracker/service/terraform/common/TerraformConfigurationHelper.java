...
public class TerraformConfigurationHelper {
     ...
     */
    static public String getBackendConfig(Map<String, String> attributes) {
        return attributes
                .entrySet()
                .stream()
     ...
     */
    static public String getEnvironmentVariables(Map<String, String> attributes) {
        return attributes
                .entrySet()
                .stream()
                .map(element -> String.format(
     ...
     * @return composed environment variables.
     */
    static public String getVariables(Map<String, String> attributes) {
        return attributes
                .entrySet()
                .stream()
                .map(element -> String.format(
     ...
     */
    static public String getContext(TerraformDeploymentApplication terraformDeploymentApplication) throws IOException {
